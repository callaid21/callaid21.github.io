        ...
        <div className='dark padding-block' id="projects">
            <div className="wrapper">
                ...
                <div className="projects-container">
                    ...
                    <div className="project even-columns">
                        <Reveal>
                                <img src="./website-screenshots/fanfindrwLarge.PNG" alt="fan finder web"/> 
                        </Reveal>
                        <div className="project-info">
                            ...
                            <div>
                                <p>FanFindr for business. Elevate your sports bar's game with our cutting-edge marketing tool! </p>
                            </div>
                            <div className="skill-blocks">
                    ...
                    <div className="project even-columns">
                        <Reveal>
                            <div>
                                <img src="./website-screenshots/fanfindr-mobile.png" alt="fan finder mobile"/> 
                            </div>
                        </Reveal>
                        <div className="project-info" id="mobile">
                            ...
                            <div>
                                <p>FanFindr for fans. Score the ultimate sports bar experience tailored to your preferences!</p>
                            </div>
                            <div className="skill-blocks">
                    ...
                    <div className="project even-columns">
                        <Reveal>
                        <div>
                           <img src="./website-screenshots/portfolioLarge.png" alt="portfolio website"/> 
                        </div>
                        </Reveal>
                        <div className="project-info">
